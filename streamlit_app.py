...
st.markdown("""
    ...
    div[data-baseweb="select"] { border: 3px solid #FFFF00 !important; border-radius: 8px !important; background-color: #000000 !important; }
    div[data-baseweb="select"] * { color: #FFFF00 !important; font-size: 20px !important; font-weight: 900 !important; }
...
t = {
    ...
    "PL": {
        ...
        "result": "🏁 Wynik obliczeń:", "conc": "Stężenie roztworu roboczego",
        "tabs": ["🧮 Kalkulator", "🚨 Protokoły awaryjne"], "tablets": "tabl. na 10L wody",
        "method": "Metoda dezynfekcji", "exp": "Zalecany czas ekspozycji",
    ...
    "DE": {
        ...
        "result": "🏁 Berechnungsergebnis:", "conc": "Konzentration der Arbeitslösung",
        "tabs": ["🧮 Rechner", "🚨 Notfallprotokolle"], "tablets": "Tabl. pro 10L Wasser",
        "method": "Desinfektionsmethode", "exp": "Empfohlene Einwirkzeit",
    ...
    "FR": {
        ...
        "result": "🏁 Résultat du calcul:", "conc": "Concentration de la solution de travail",
        "tabs": ["🧮 Calculateur", "🚨 Protocoles d'urgence"], "tablets": "comprimés pour 10L d'eau",
        "method": "Méthode de désinfection", "exp": "Temps d'exposition recommandé",
    ...
    "ES": {
        ...
        "result": "🏁 Resultado del cálculo:", "conc": "Concentración de la solución de trabajo",
        "tabs": ["🧮 Calculadora", "🚨 Protocolos de emergencia"], "tablets": "pastillas por 10L de agua",
        "method": "Método de desinfección", "exp": "Tiempo de exposición recomendado",
    ...
    "IT": {
        ...
        "result": "🏁 Risultato del calcolo:", "conc": "Concentrazione della soluzione di lavoro",
        "tabs": ["🧮 Calcolatore", "🚨 Protocolli di urgenza"], "tablets": "compresse per 10L d'acqua",
        "method": "Metodo di disinfezione", "exp": "Tempo di esposizione raccomandato",
...
with tab_home:
    ...
    if df is not None:
        ...
        tech_cont = "YES" if selected_cont_label in ["ТАК", "YES", "TAK", "JA", "OUI", "SÍ", "SIM"] else "NO"
        ...
        if not final_row_df.empty:
            ...
            if 'Tablets' in final_row and pd.notna(final_row['Tablets']) and str(final_row['Tablets']).strip() != "—":
                st.success(f"🧫 КІЛЬКІСТЬ: {final_row['Tablets']} {t[lang]['tablets']}")
